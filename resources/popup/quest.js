		...
		function validateAnswer(){
			if($("#ans").val()==ans){
				...
				if(typeof getUrlVars()["ans"] === 'undefined'){
					$("#nxa").html("<div class='alert alert-success'>Congratulations!!!</div>");
					setTimeout(function() {
						$('body').fireworks();
					});
				}else{
    	...
    	$(function() {
			...
			//alert(getUrlVars()["ans"]);
				$("#kount").html("<h3>Answre is: " + getQuest()[parseInt(getUrlVars()["ans"])].answer + "</h2>");
				$("#form-example").html("");
			 }else{
				$('#mq').html('<h3><i class="fa fa-question-circle"></i> ' + que + '</h3>')
			 }
...
function getQuest(){
	...
	'{"question":"In a normal human body, the total number of red blood cells are","answer":"30 trillion"},' +
